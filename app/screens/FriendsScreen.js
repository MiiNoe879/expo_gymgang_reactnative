...
import { getFriendsMenuItems } from './data/menuItems.js';
...
export default class FriendsScreen extends React.Component {
  ...
  render() {
    ...
    const friends = getFriendsMenuItems(navigate);
    ...
    return (
      <KeyboardAvoidingView behavior='padding' style={styles.container}>
        ...
        <ScrollView>
          ...
          <Badge type='friends' label='friends.friends' top={160} />
